...
const TaskManager = ({ project, onClose, onUpdate }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <Toaster /> 
      <div className="bg-teal-700 rounded-lg p-8 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl text-center font-bold">Task Manager - {project.title}</h2>
        ...
        <button
          ...
          className="mb-6 bg-emerald-500 text-white px-4 py-2 rounded flex items-center gap-2 hover:bg-gray-900 transition-colors"
        >
